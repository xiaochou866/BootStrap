...
module.exports = function (grunt) {
  ...
  if (runSubset('core')) {
    testSubtasks = testSubtasks.concat(['bootstrap-css', 'bootstrap-js', 'stylelint:bootstrap', 'test-js', 'docs']);
  }
  ...
  grunt.registerTask('bootstrap-css', ['less:core', 'less:theme', 'postcss:core', 'postcss:theme', 'cssmin:core', 'cssmin:theme']);
